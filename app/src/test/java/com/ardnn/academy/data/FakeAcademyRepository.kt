...
import com.ardnn.academy.data.source.remote.ApiResponse
...
class FakeAcademyRepository constructor(
    ...
    override fun getCourseWithModules(courseId: String): LiveData<Resource<CourseWithModule>> {
        return object : NetworkBoundResources<CourseWithModule, List<ModuleResponse>>(appExecutors) {
