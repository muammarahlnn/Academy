...
class HomeActivityTest {
    ...
    private val dummyBookmarks = DataDummy.generateDummyBookmarks()
...
//    var activityRule = ActivityScenarioRule(HomeActivity::class.java)
    ...
    fun loadBookmarks() {
        ...
        onView(withId(R.id.rv_bookmark)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(dummyBookmarks.size))
    }
}